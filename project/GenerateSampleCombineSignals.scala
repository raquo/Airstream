...
case class GenerateSampleCombineSignals(
  ...
  override def apply(): Unit = {
    ...
    line()
    line("// #Warning do not edit this file directly, it is generated by GenerateSampleCombineSignals.scala")
    line()
    ...
    for (n <- from to to) {
      ...
      enter(s") extends SampleCombineSignalN[Any, Out](", ")") {
        ...
        line("sampledSignals = " + tupleType(n - 1, prefix = "sampledSignal", suffix = ".toObservable", separator = " :: ") + " :: Nil,")
