...
case class GenerateCombineSignalOps(
  traitName: String,
  sourceDir: File,
  from: Int,
  to: Int
  ...
  override def apply(): Unit = {
    ...
    line()
    line("// These combine / combineWith / withCurrentValueOf / sample methods are available on all signals")
    line("// For combine / combineWithFn methods on the Signal companion object, see CombineSignalObjectOps.scala")
    line()
