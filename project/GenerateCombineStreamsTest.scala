...
case class GenerateCombineStreamsTest(
  ...
  testSourceDir / "scala" / "com" / "raquo" / "airstream" / "combine" / "generated" / s"$className.scala"
) {
  ...
  def apply(): Unit = {
    ...
    line()
    line("// #Warning do not edit this file directly, it is generated by GenerateCombineStreamsTest.scala")
    line()
    enter(s"class $className extends UnitSpec {", "}") {
      line()
      for (i <- 1 to to) {
