...
class CombineEventStream9[T1, T2, T3, T4, T5, T6, T7, T8, T9, Out](
  ...
  protected[this] val parent8: EventStream[T8],
  protected[this] val parent9: EventStream[T9],
  combinator: (T1, T2, T3, T4, T5, T6, T7, T8, T9) => Out
) extends CombineEventStreamN[Any, Out](
  parents = List(parent1, parent2, parent3, parent4, parent5, parent6, parent7, parent8, parent9),
