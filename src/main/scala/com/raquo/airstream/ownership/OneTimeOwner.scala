...
/** Owner that can not be used after it was killed. Used in Laminar via
  * [[DynamicOwner]].
  *
  * @param onAccessAfterKilled
  *   Called if you attempt to use this owner after it was killed. It's intended
  *   to log and/or throw for reporting / debugging purposes.
  */
